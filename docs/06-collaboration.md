...
![A task's comment timeline, with comments from a few different users](screenshots/tender-tasks-comments.jpg)
...
![The upload modal for adding a new attachment to a task](screenshots/tender-tasks-attachment-upload-modal.jpg)
...
![A task list's row action menu with Add comment and Add attachment visible](screenshots/add-comment-and-attachment.jpg)
