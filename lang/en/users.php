...
return [
    ...
    'infolist' => [
        ...
        'no_service_category' => 'Management (all categories)',
        'skills_heading' => 'Skills matrix',
        'profile_heading' => 'Employee profile',
        'meta_heading' => 'Record history',
        'tenders_handled' => 'Tenders handled',
        'on_time_completion_rate' => 'On-time completions',
        'correction_loop_count' => 'Correction loops',
