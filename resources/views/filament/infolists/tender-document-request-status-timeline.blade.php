            ...
            <div class="min-w-0 flex-1 pt-0.5">
                ...
                @if ($change->from_status)
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        {{ __('tender_document_requests.infolist.status_change_from') }} {{ $change->from_status->getLabel() }}
                    </p>
                @endif

                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    {{ $change->changedBy?->name ?? __('tender_document_requests.infolist.unknown_actor') }}
                    &middot;
