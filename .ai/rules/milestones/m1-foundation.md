...
Full spec: [idea.md](../../../idea.md)'s M1 section. Index: [../milestones.md](../milestones.md).
...
**M1's acceptance points (idea.md) are met** — see [m2-team-tasks.md](m2-team-tasks.md) for
the joint M1+M2 confirmation. Don't build ahead into M3+ scope without the user asking for it
explicitly.
