...
M1-M9 are complete. Don't start the next not-started milestone (M10) without
the user asking for it explicitly — e.g. don't wire up M10's competitors/market-intelligence
